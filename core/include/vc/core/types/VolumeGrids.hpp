...
class VolumeGrids : public DiskBasedObjectBaseClass,
               public std::enable_shared_from_this<VolumeGrids>
{
public:
    /** Bounding Box type */
    ...
    /** Shared pointer type */
    using Pointer = std::shared_ptr<VolumeGrids>;
    ...
    /** @brief Load the VolumeGrids from a directory path */
    explicit VolumeGrids(volcart::filesystem::path path);

    /** @brief Make a new VolumeGrids at the specified path */
    VolumeGrids(volcart::filesystem::path path, Identifier uuid, std::string name);

    /** @overload VolumeGrids(volcart::filesystem::path) */
    static Pointer New(volcart::filesystem::path path);

    /** @overload VolumeGrids(volcart::filesystem::path, Identifier, std::string) */
    static Pointer New(
    ...
    /** @brief Get the minimum intensity value in the VolumeGrids */
    double min() const;
    /** @brief Get the maximum intensity value in the VolumeGrids */
    double max() const;
    /**@}*/
    ...
    /** @brief Set the minimum value in the VolumeGrids */
    void setMin(double m);
    /** @brief Set the maximum value in the VolumeGrids */
    ...
    Bounds bounds() const;
    /** @brief Return whether a position is within the VolumeGrids bounds */
     ...
     *
     * Index must be less than the number of slices in the VolumeGrids.
     *
    ...
    /**
     * @brief Create a Reslice image by intersecting the VolumeGrids with a plane
     *
